...
section_links:
  ...
  - { id: basis-images, title: The columns show the action }
  - { id: matrix-vector-product, title: Matrix times vector }
  - { id: transformation-gallery, title: A gallery of transformations }
...
--8<-- "lecture-05/sections/01-one-action.md"
--8<-- "lecture-05/sections/02-basis-images.md"
--8<-- "lecture-05/sections/03-matrix-vector-product.md"
--8<-- "lecture-05/sections/04-transformation-gallery.md"
